...
import application.FFKtranslatorController;
...
public class AppLogic {
    ...
    public void setComponents(TextArea textAreaCode, TextArea sorceOutput, TextArea convertionOutput, VBox listConvertions, 
    		...
    		Label translatedFileNum, Label nameAccount) {
	...
	public void countNumFile() {
		try {
			numTraslatedFile = (new File(getClass().getResource("/KVFiles").toURI())).listFiles().length;
    ...
    public void SearchConvertionsForHistory() throws IOException, URISyntaxException{
    	File[] listOfFXMLFiles = (new File(getClass().getResource("/FXMLFiles").toURI())).listFiles();
    	File[] listOfKVFiles = (new File(getClass().getResource("/KVFiles").toURI())).listFiles();
    			    	...
    			    	if(mouseEvent.isPrimaryButtonDown()) {
                    		...
                    		moreOptionPane.getChildren().get(1).setOnMouseClicked(new EventHandler<MouseEvent>() {
                				...
                				public void handle(MouseEvent event) {
                					try {
                						File kv = new File(getClass().getResource("/KVFiles/" + ((Text)convertion.getChildren().get(1)).getText()).toURI());
                						File fxml = new File(getClass().getResource("/FXMLFiles/" + ((Text)convertion.getChildren().get(0)).getText()).toURI());
    ...
    public void FindRecents() throws Exception{
    	...
    	if(listOfFXMLFiles != null && listOfKVFiles != null)
    	if(listOfFXMLFiles.length != 0 && listOfKVFiles.length != 0) {
                            ...
                            try {
                            	if(event.getButton() == MouseButton.PRIMARY)
                            		...
                            		moreOptionPane.getChildren().get(1).setOnMouseClicked(new EventHandler<MouseEvent>() {
                        				...
                        				public void handle(MouseEvent event) {
                        					try {
                        						File kv = new File(getClass().getResource("/KVFiles/" + ((Text)((HBox)((Pane)recentConvertions.getChildren().get(0)).getChildren().get(0)).getChildren().get(2)).getText()).toURI());
                        						File fxml = new File(getClass().getResource("/FXMLFiles/" + ((Text)((HBox)((Pane)recentConvertions.getChildren().get(0)).getChildren().get(0)).getChildren().get(1)).getText()).toURI());
                            ...
                            try {
								...
								ReadingFile(new File(getClass().getResource("/KVFiles/" + ((Text)((HBox)((Pane)((HBox)recentConvertions.getChildren().get(1)).getChildren().get(0)).getChildren().get(0)).getChildren().get(1)).getText()).toURI()));
                            		...
                            		moreOptionPane.getChildren().get(1).setOnMouseClicked(new EventHandler<MouseEvent>() {
                        				...
                        				public void handle(MouseEvent event) {
                        					try {
                        						File kv = new File(getClass().getResource("/KVFiles/" + ((Text)((HBox)((Pane)((HBox)recentConvertions.getChildren().get(1)).getChildren().get(0)).getChildren().get(0)).getChildren().get(1)).getText()).toURI());
                        						File fxml = new File(getClass().getResource("/FXMLFiles/" + ((Text)((HBox)((Pane)((HBox)recentConvertions.getChildren().get(1)).getChildren().get(0)).getChildren().get(0)).getChildren().get(0)).getText()).toURI());
